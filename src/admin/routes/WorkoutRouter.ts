...
router.get('/workout-profiles', (req, res) => res.json([]));
...
router.get('/workout-profiles/:workoutProfileId/logs', (req, res) => res.json([]));
...
router.get('/workout-profiles/:workoutProfileId/logs/:workoutLogId/exercises', (req, res) => res.json([]));
router.post(
